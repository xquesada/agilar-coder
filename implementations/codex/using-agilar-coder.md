...
| 9. Close | scrum-master | Update backlog tool status to `done` (mandatory), move PBI to `backlog/done/`, update CHANGELOG.md, suggest version bump, update docs/CLAUDE.md |
